...
img_path = "..\\res\\tmp.png"
file_path = "..\\output\\your_achievements.txt"
achievements = ""
...
print("1 - Go to \"Wonders of the World\" achievements list.")
print("2 - Scroll the list until the first completed achievement is on the TOP of the list.")
